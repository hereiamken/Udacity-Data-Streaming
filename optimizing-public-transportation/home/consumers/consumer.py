...
class KafkaConsumer:
    ...
    def __init__(
        ...
        self.broker_properties = {
            ...
            """,
            "group_id": f"{self.topic_name_pattern}",
    ...
    def _consume(self):
        ...
        while True:
            message_consumer = self.consume.poll(self.consumer.consume_timeout)
            if message_consumer is None:
                logger.debug("no messages received")
                return 0
            elif message_consumer.error() is not None:
                logger.debug("error {message_consumer.error()}")
                return 0
            else:
